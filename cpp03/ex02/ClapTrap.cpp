...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        std::cout << this->name << " can't be repaired for more than" << this->energyPoints <<  "hit points!" << std::endl;
    }
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    if (amount > hitPoints)
    {
        std::cout << this->name << " can't take more than" << this->hitPoints << " points of damage!" << std::endl;
    }
    if (this->hitPoints == 0)
    {
